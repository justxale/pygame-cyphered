...
def multiple_text_discpl(screen, text_surface, pos, fontt=None, font_size=50, color=(255, 255, 255)):
    ...
    x, y = pos
    font = pygame.font.SysFont(fontt, font_size)
    for line in words:
        for word in line:
            word_surface = pygame.font.SysFont('Times New Roman', font_size).render(word, 0, color)
